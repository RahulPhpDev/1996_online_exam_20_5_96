@extends('layouts.partials_testing.inner_layout')

@extends('layouts.partials_testing.header')
@extends('layouts.partials_testing.sidebar')
@extends('layouts.partials_testing.footer')
@section('title', $title)
