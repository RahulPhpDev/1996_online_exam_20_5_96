    ...
    frm.submit(function (e) {
        ...
        <div class="mycontainer question_section">
            ...
            <div class = "questions">
             ...
             <div class="controls">
                ...
                <button name="save" type="submit" value="continue" class="btn btn-success savebtn btn-exam-custom">Save</button>

                <button name="save" type="submit" value="preview" class="btn hidden-sm btn-primary savebtn btn-exam-custom hidden-sm">Preview</button>

                <button name="save" type="submit" value="skip" class="btn btn-danger savebtn btn-exam-custom">Skip </button>
     ...
     <div class = "question_count_div panel"> <h2>  Question </h2> </div>
       <?php 
          ...
          <?php $i++;}  } ?>
           <a href="JavaScript:void(0);" class="close close_circle circle hide_in_lap"><i class="fa fa-close" style="color:red  ;  font-size: 25px;" ></i></a>
        </div>
